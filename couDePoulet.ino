...
void setup()
{
  ...
  delay(1000); 
	if (c == 0x71) {// WHO_AM_I should always be 0x68 
	   ...
	   // initialise 3 variables : MPU9250aRes, MPU9250gRes, MPU9250mRes tout 
	   // simplement
		MPU9250getAres();
		MPU9250getGres();
		MPU9250getMres();
		...
		Serial.println(" Calibrate MPU9250 gyro and accel..enfin pas l'acceleration en fait. elle ne fait que s'afficher'");
...
//Pas de power mngt
//règle l'horloge
// configure bp et fre de refresh des gyro et accelero
// configure l'échelle de mesure de G et A
// configure interuption sur données brute
// i2c en mode transparent.
void initMPU9250()
{  
 // wake up device
...
// recupere des parametres de sensibilite du magnetometre ASAX
// configure sa refresh freq et sa resolution des mesures
